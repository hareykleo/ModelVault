...
#[derive(Debug)]
pub struct ModelVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModelVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModelVault processing");
    
    let mut processor = ModelVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModelVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModelVaultProcessor::new(false);
